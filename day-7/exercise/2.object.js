class Car {
    ...
    constructor(color, roda, merk) {
      // penamaan dari isi di constractor akan disesuaikan sama yang kita definisikan
      ...
      // kenapa kita pake constractor = Untuk mendefinisikan isi object yang diambil dari kerangkanya/properties, yang dapat diubah nilainya, dan mengurangi duplikasi
